...
void Application::Display(void)
{
	...
	//m_qOrientation = glm::angleAxis(1.0f, vector3(1.0f));
	
	//convert our vector 3 euler into quaternions
	m_qOrientation = quaternion(vector3(m_v3Rotation.x, m_v3Rotation.y, m_v3Rotation.z));

	m_qOrientation = m_qOrientation * glm::angleAxis(1.0f, vector3(0.0f, 0.0f, 0.0f));
